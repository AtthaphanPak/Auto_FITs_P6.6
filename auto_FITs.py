...
def Handshake(model : str, operation : str, serial : str):
...
def Log(model : str, operation : str, parameters : str, values : str):
    list_parameters = {}
    lib = Dispatch("FITSDLL.clsDB")
    ## Define Shift 
...
def Query(model : str, operation : str, serial : str, query_parameters : str):
    lib = Dispatch("FITSDLL.clsDB")
    query_array = []
